...
class ErrorCode(str, Enum):
    ...
    FEATURE_FLAG_MODULE_DISABLED = "FEATURE_FLAG_MODULE_DISABLED"

    QURAN_MODULE_DISABLED = "QURAN_MODULE_DISABLED"
    MASJID_MODULE_DISABLED = "MASJID_MODULE_DISABLED"
    AUTH_MODULE_DISABLED = "AUTH_MODULE_DISABLED"
    USER_PERSISTENCE_MODULE_DISABLED = "USER_PERSISTENCE_MODULE_DISABLED"
