...
class AudioService(BaseService):
    ...
    def get_juz_recitation_audio(self, juz_number: int, recitation_id: int, page: int = 1):
        ...
        for chapter_id in chapter_ids:
            try:
                chapter_audio = self._get(f"/content/api/v4/chapter_recitations/{recitation_id}/{chapter_id}")
                audio_files.append({
